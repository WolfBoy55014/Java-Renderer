...
public class SquareLight extends MarchingLight {

    private final double halfSize;
    private final double surfaceArea;

    public SquareLight(double[] position, double[] rotation, Color color, double intensity, double size) {
        super(position, rotation, color, intensity);
        this.halfSize = size / 2.0d;
        this.surfaceArea = size * size * 2.0d;
    }

    public SquareLight(double[] position, double[] rotation, double[] color, double intensity, double size) {
        super(position, rotation, color, intensity);
        this.halfSize = size / 2.0d;
        this.surfaceArea = size * size * 2.0d;
    }
